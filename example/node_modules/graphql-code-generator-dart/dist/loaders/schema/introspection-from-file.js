...
var IntrospectionFromFileLoader = /** @class */ (function () {
    ...
    IntrospectionFromFileLoader.prototype.handle = function (pointerToSchema, cliOptions) {
        var _this = this;
        graphql_codegen_core_1.logger.info("Loading GraphQL Introspection from file: " + pointerToSchema + "...");
