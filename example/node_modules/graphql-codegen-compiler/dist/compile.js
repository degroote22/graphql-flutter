...
function compileTemplate(config, templateContext, documents, settings) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var isExternalProcessingFunction, executionSettings, mergedDocuments, externalFn, result, e_1, templates_1, compiledTemplates;
            ...
            switch (_a.label) {
                ...
                case 5:
                    ...
                    if (config.inputType === graphql_codegen_core_1.EInputType.SINGLE_FILE) {
                        ...
                        return [2 /*return*/, generate_single_file_1.generateSingleFile(handlebars_1.compile(clean_template_1.cleanTemplateComments(templates_1['index'])), executionSettings, config, templateContext, mergedDocuments)];
                    }
                        ...
                        return [2 /*return*/, generate_multiple_files_1.generateMultipleFiles(compiledTemplates, executionSettings, config, templateContext, mergedDocuments)];
                    }
                    else {
