...
//     if (observableQueries.isEmpty ||
//         !observableQueries[0].options.areEqualTo(makeOptions(widget.options))) {
//       _initQuery();
//     }
//   }
...
//               ? [
//                   ...snapshot.data,
//                   observableQueries.last != null
//                       ? QueryResult(
//                           data: observableQueries.last.latestResult.data,
//                           errors: observableQueries.last.latestResult.errors,
//                           loading: true,
//                           optimistic:
//                               observableQueries.last.latestResult.optimistic,
//                           source: observableQueries.last.latestResult.source,
//                         )
...
//             var refetched = false;
//             observableQueries.forEach((observableQuery) {
//               var result = observableQuery.refetch();
//               refetched = refetched || result;
//             });
//             return refetched;
//           },
//           fetchMore: _fetchMore,
//           loadingMore: length_difference,
//         );
//       },
//     );
//   }
